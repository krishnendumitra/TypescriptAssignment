class Education {
    constructor(private primarySchool: string, private highSchool: string, private college: string) {
...
class SocialLinks {
    constructor(private linkedIn: string, private twitter: string, private gitHub: string, private website: string) {
...
class Profile {
    ...
    constructor(userName: string, mobilePhone: string, relationShipStatus: string,
        gender: string, profileId: number, picture: string, education: Education, address: string, birthDay: string, socialLinks: SocialLinks,
        work: string[], primaryEmail: string, secondaryEmail: string, aboutUser: string,
        lifeEvents: string[]) {
...
let socialLinks = new SocialLinks("linkedin.com", "twitter.com", "github.com", "newwebsite.com");
let works: string[] = ["jobA", "jobB", "jobC"];
let lifeEvents: string[] = ["born", "enjoyed life", "death"];

let myProfile = new Profile("newUser", "123456789", "single", "male", 1021456923145698, "http://demourl.com", education, "abc street kolkata", "19/12/1995", socialLinks, works, "abc@gmail.com", "def@gmail.com", "A good person", lifeEvents);
