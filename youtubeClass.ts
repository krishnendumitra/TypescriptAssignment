class Comments {
    ...
    constructor(userName: string, date: string, description: string, likeCount: number, dislikeCount: number, replyCount: number, ) {
...
class Video {
    ...
    constructor(id: string, title: string, uploadedBy: string,
        duration: number, subtitle: string[], viewCount: number, likeCount: number, dislikeCount: number, subscriberCount: number,
        notificationSunscriberCount: number, description: string, dateOfPublish: string, category: string, license: string) {
        this.id = id;
        this.title = title;
...
let travelVideo = new Video("uniqueId", "This is a video", "TheGuyWithBadIdeas",
    30.55, ["English", "Hindi"], 200, 150, 50, 60, 20, "A random description",
    "25/08/2018", "Travel", "Standard YouTube License")

let comments: Comments[] = [];
let comment1 = new Comments("TheGuyWithGoodIdeas", "26/05/2018", "A very good comment", 60, 10, 50);
let comment2 = new Comments("TheGuyWithNewIdeas", "21/05/2018", "A good comment", 30, 40, 12);
